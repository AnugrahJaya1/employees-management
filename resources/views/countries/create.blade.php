...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Contries</h1>
</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('countries.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('fname') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
